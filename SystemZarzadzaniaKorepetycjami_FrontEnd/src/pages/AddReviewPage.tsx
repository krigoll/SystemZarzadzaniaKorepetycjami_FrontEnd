                    ...
                    <>
                        {reviews?.some((review) => review.idPerson === uId) ? (
                            <div className="review-item">
                                ...
                                <p>{reviews.find((review) => review.idPerson === uId)?.content}</p>
                            ...
                            <div>
                                ...
                                <div className="button-container">
                                    <AppButton label={creating ? 'Dodawanie...' : 'Akceptuj'} onClick={handleAddReview} disabled={creating} />

                                </div>
                            </div>
                        )}
                        {createError && <p className="error-message">Błąd: {createError}</p>}
                    </>
                )}
